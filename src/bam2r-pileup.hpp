...
struct BaseInfo {
	...
	void from_pinfo(const PileupReadInfo &p, const NTParams &params) {
...
KHASH_MAP_INIT_STR(strh, BaseInfoPair)
...
class BalancedPairCounter {
	...
	*/
	...
	public:
		int score_pair(const BaseInfoPair info, const uint64_t param_length, int *counts) {
